...
export class Formulario {
    constructor() {
        this.datos = {
            ...
            //Fecha de nacimiento
            nacimiento: '', //dia, mes y año Fecha de nacimiento
    ...
    accederDom() {
        ...
        //Fecha de nacimiento
        this.domInpFechaNacimiento = document.querySelector('#day') + document.querySelector('#month') + document.querySelector('#year')
    ...
    mostrarFechaActual() {
        //Jueves día 13 de Junio del año 2013
